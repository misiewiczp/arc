...
#ifndef __arc_req_plan_mpc_t_hpp__
#define __arc_req_plan_mpc_t_hpp__
...
int req_plan_mpc_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int req_plan_mpc_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int req_plan_mpc_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t req_plan_mpc_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* req_plan_mpc_t::getTypeName()
{
    return "req_plan_mpc_t";
}

int req_plan_mpc_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->dir, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int req_plan_mpc_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->dir, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int req_plan_mpc_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t req_plan_mpc_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xfd3b38eeb5705ac6LL;
