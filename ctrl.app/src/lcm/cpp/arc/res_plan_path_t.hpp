...
#ifndef __arc_res_plan_path_t_hpp__
#define __arc_res_plan_path_t_hpp__
...
int res_plan_path_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int res_plan_path_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int res_plan_path_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t res_plan_path_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* res_plan_path_t::getTypeName()
{
    return "res_plan_path_t";
}

int res_plan_path_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int res_plan_path_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int res_plan_path_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t res_plan_path_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xb71f6b76db39f193LL;
