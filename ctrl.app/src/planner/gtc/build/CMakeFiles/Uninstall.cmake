...
if(NOT EXISTS "/var/opt/arc/ctrl.app/src/planner/gtc/build/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: /var/opt/arc/ctrl.app/src/planner/gtc/build/install_manifest.txt")
endif()

# remove files from 'install_manifest.txt'
message(STATUS "")
message(STATUS "Removing files from 'install_manifest.txt'")
file(READ "/var/opt/arc/ctrl.app/src/planner/gtc/build/install_manifest.txt" files)
